(function () {
  ...
  var setHue = function (e) {
    var h$$1 = parseInt(e.target.value);
    
    if (h$$1 >= 0 && h$$1 <= 360) {
      var newHSL = [h$$1, APP.color.hsl[1], APP.color.hsl[2], APP.color.hsl[3]];
      setHSL(newHSL);
    }
  };
  ...
  var setLightness = function (e) {
    var l$$1 = parseInt(e.target.value);
    
    if (l$$1 >= 0 && l$$1 <= 100) {
      var newHSL = [APP.color.hsl[0], APP.color.hsl[1], l$$1, APP.color.hsl[3]];
      setHSL(newHSL);
    }
  };
  ...
  var getPoint = function (imgDataArr, x$$1, y$$1, w, h$$1) {
    ...
    if (x$$1 >= 0 && x$$1 < w && y$$1 >= 0 && y$$1 < h$$1) { // check bounds
      var i = (x$$1 + w * y$$1) * 4;
      return [
        imgDataArr[i + 0],
        imgDataArr[i + 1],
  ...
  var setPoint = function (imgDataArr, x$$1, y$$1, w, h$$1, color) {
    if (!imgDataArr) { throw Error(("setPoint: " + imgDataArr + " undefined")) }
    if (!imgDataArr.length) { throw Error(("setPoint: " + imgDataArr + " not a valid array")) }
  ...
  var getColorAtPixel = function (data, x$$1, y$$1, w) {
    var linearCord = (y$$1 * w + x$$1) * 4;
      ...
      while (
        ...
        if (x$$1 > 0) {
          if (
            ...
            if (!reached_left) {
              pixel_stack.push({ x: x$$1 - 1, y: y$$1 });
              reached_left = true;
            }
  ...
  var circle = function (xCenter, yCenter, currX, currY, func) {
    ...
    var circlePlot = function () {
      func(xCenter + x$$1, yCenter + y$$1);
      func(xCenter + y$$1, yCenter + x$$1);
      func(xCenter - x$$1, yCenter + y$$1);
      func(xCenter - y$$1, yCenter + x$$1);
      func(xCenter + x$$1, yCenter - y$$1);
      func(xCenter + y$$1, yCenter - x$$1);
    ...
    circlePlot(xCenter, yCenter, x$$1, y$$1);

    while (x$$1 <= y$$1) {
      x$$1++;
      if (p < 0) {
        p += 2 * x$$1 + 1; // Mid point is inside therefore y remains same
  ...
  var squareFilled = function (startX, startY, endX, endY, w, h$$1, color, func) {
    var points = [];
  ...
  var paintCanvas = function (gestureEvent) {
    ...
    var setBrushPoints = function (canvas, x$$1, y$$1, w, h$$1, color) {
      squareFilled(x$$1 - VIEW.brushSize, y$$1 - VIEW.brushSize, x$$1 + VIEW.brushSize, y$$1 + VIEW.brushSize, w, h$$1, color, function (x$$1, y$$1) {
        setPoint(canvas, x$$1, y$$1, w, h$$1, color);
      });
    };
    ...
    if (APP.tool === 'pencil' || APP.tool === 'eraser') {
      ...
      line(prevX, prevY, currX, currY, function (x$$1, y$$1) {
        setBrushPoints(target, x$$1, y$$1, APP.width, APP.height, APP.tool === 'pencil' ? APP.color.rgb : [0, 0, 0, 0]);
      });
    }
    ...
    if (APP.tool === 'line' || APP.tool === 'circle' || APP.tool === 'square') {
      ...
      funcs[APP.tool](startX, startY, currX, currY, function (x$$1, y$$1) {
        setBrushPoints(gestureEvent === 'start' || gestureEvent === 'resume' ? preview : target, x$$1, y$$1, APP.width, APP.height, APP.color.rgb);
      });
    }
